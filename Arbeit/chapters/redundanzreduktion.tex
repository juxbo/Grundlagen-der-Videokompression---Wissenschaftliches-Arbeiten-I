...
% Ein Blockende beinhaltet implizit die Anzahl der 0en. No need for redundancy.
Da durch die Quantisierung lange Nullfolgen entstehen, ist eine kombinierte Anwendung empfehlenswert.
% Was für eine kombinierte Anwendung? Huffman-Codierung wird doch erst weiter unten erklärt?!
...
% Gibt es da eine Quelle? Die Kompressionsleistung sollte nach meinem Verständnis nach sehr stark vom encodeten Bild Abhängen. Ein komplett schwarzes Bild ist damit sehr gut komprimierbar, ein Bild mit vielen feinen Details dafür sehr schlecht.
