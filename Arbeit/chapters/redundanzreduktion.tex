...
Bei dem Videokompressionsstandard MPEG, wird die Entropiecodierung mittels einer variabler Lauflängencodierung, gefolgt von einer Huffman-Codierung realisiert. Der Bitstrom eines Videos, welches zuvor quantisiert wurde, wird dabei komplett auf aufeinanderfolgende Null-Bits untersucht. Diese werden anschließend zusammengefasst, indem daran ein Blockende mit Anzahl der Nullen angehängt wird. Da durch die Quantisierung lange Nullfolgen erstehen, ist eine kombinierte Anwendung empfehlenswert.
...
Durch das Zusammenspiel von Irrelevanzreduktion mit Quantisierung, variabler Lauflängen-, sowie Huffman-Codierung ist eine effektive Kompression des gesamten Bitstroms um \textcolor{blue}{1:10}, ohne eine merkbare Verminderung der Bildqualität möglich.
